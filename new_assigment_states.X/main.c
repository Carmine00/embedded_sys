 ...
 * Author: lucap
 *
 * Created on 10 novembre 2023, 15.54
 */
...
void disable_interrupts(){
    ...
    IEC1bits.U2RXIE = 0;  // uart rx interrupt enabler
    IEC0bits.INT0IE = 0;  // button s5 interrupt
    IEC1bits.INT1IE = 0;  // button s6 interrupt
    
}

void enable_interrupts(){
    
    IEC1bits.U2RXIE = 1;  // uart rx interrupt enabler
    IEC0bits.INT0IE = 1;  // button s5 interrupt
    IEC1bits.INT1IE = 1;  // button s6 interrupt
